...
<section class="banner-main-con" id="home">
    <div class="container pl-0 pr-0">
        ...
        <div class="footer-social-icon banner-social-icon mb-0">
            ...
            <li class="">
                <a href="https://github.com/berkanyldrim/"><i class="fab fa-github d-flex align-items-center justify-content-center"></i></a>
            </li>
            <li class="mt-3 mb-3">
                <a href="https://dev.to/berkanyldrim/"><i class="fab fa-dev d-flex align-items-center justify-content-center ml-0 mr-0 "></i></a>
            </li>
            <li class="">
                <a href="https://www.linkedin.com/in/berkanyldrim/"><i class="fab fa-linkedin-in d-flex align-items-center justify-content-center"></i></a>
            </li>
            </ul>
        </div>
            ...
            <div class="col-lg-7 col-sm-12 d-flex justify-content-center flex-column">
                <div class="banner-left-con wow slideInLeft">
                    <div class="banner-heading">
                        ...
                        <li><h1>Berkan Yıldırım</h1></li>
                        <li><h1>Berkan Yıldırım</h1></li>
                        <li><h1>Berkan Yıldırım</h1></li>
                        <li><h1>Berkan Yıldırım</h1></li>
                        </ul>
                        <p>I'm Full Stack Developer at Albert Solino
                        </p>
                    </div>
